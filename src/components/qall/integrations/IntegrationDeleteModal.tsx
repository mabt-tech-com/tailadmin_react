...
export default function IntegrationDeleteModal({
  ...
  return (
      ...
      <button
        ...
        className="shadow-theme-xs inline-flex h-11 items-center justify-center rounded-lg border border-red-300 px-4 py-3 text-sm font-medium text-red-500/70 dark:border-red-500/70 dark:text-red-400/70"
      >
        <Trash2 />
      </button>
